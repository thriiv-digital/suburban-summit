  ...
  return (
    <header className={`nav nav-dark-hero ${scrolled ? "is-scrolled" : ""}`}>
      ...
      <nav className="nav-links">
        ...
        <a href="about.html#model">The Model</a>
        <a href="events.html">Events</a>
        <a href="community.html">Community</a>
        <a href="#tickets">Tickets</a>
      </nav>
      <div className="nav-actions">
        <a href="exhibit.html" className="btn btn-ghost btn-sm">Exhibit</a>
...
/* ── PageNav (inner pages — always white) ────────────────────── */
const PAGE_HUMANITIX = "https://events.humanitix.com/suburban-business-summit-northern-beaches/tickets";
function PageNav({ active = "" }) {
  return (
    <header className="nav nav-page is-scrolled">
      ...
      <nav className="nav-links">
        ...
        <a href="events.html"    className={active === "events"    ? "nav-active" : ""}>Events</a>
        <a href="community.html" className={active === "community" ? "nav-active" : ""}>Community</a>
        <a href="exhibit.html"   className={active === "exhibit"   ? "nav-active" : ""}>Exhibit</a>
      </nav>
      <div className="nav-actions">
        <a href="exhibit.html" className="btn btn-ghost btn-sm">Exhibit</a>
        <button onClick={() => window.open(PAGE_HUMANITIX,"_blank","noopener,noreferrer")} className="btn btn-primary btn-sm">Book a ticket <span className="btn-arrow"></span></button>
      </div>
    </header>
  );
}

/* ── PageHero (dark banner for inner pages) ──────────────────── */
function PageHero({ eyebrow, title, sub, children }) {
  return (
    <section className="page-hero">
      <div className="container">
        {eyebrow && <div className="eyebrow page-hero-eyebrow">{eyebrow}</div>}
    ...
    <footer className="foot">
      <div className="container">
        <div className="page-foot-inner">
          <a href="index.html" className="nav-logo" style={{marginBottom:0}}>
            <img src="images/logo-suburban-business-summit.png" alt="Suburban Business Summit" className="nav-logo-img" style={{height:36}} />
          </a>
          <nav className="page-foot-links">
            <a href="about.html">About</a>
            <a href="events.html">Events</a>
            <a href="community.html">Community</a>
          ...
          <p className="small" style={{color:"var(--muted)",margin:0}}>&copy; 2026 Suburban Business Summit</p>
        </div>
      </div>
    </footer>
  );
...
window.SubParts = { Icon, Photo, RotatingPhoto, Nav, Reveal, SpeakerModal, renderGlyph, PageNav, PageHero, PageFooter };
