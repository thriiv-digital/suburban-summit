...
function AboutSnippet() {
  const stats = [
    ...
    { v: "4",    l: "NSW locations in 2026" },
    { v: "40%",  l: "Of ticket revenue to charity" },
  ];
  return (
    <section className="section" id="about">
      <div className="container">
        <div className="about-snippet-grid">
          <Reveal className="about-snippet-text">
            ...
            <p className="lede" style={{marginBottom:28}}>
              We bring big-conference ideas, speakers and connections into suburban and regional areas — close to where you live and where you actually do the work.
            </p>
            <a href="about.html" className="btn btn-ghost">Our story →</a>
          </Reveal>
          <Reveal delay={100}>
      ...
      <div className="container">
        <div className="spotlight-grid">
          <Reveal className="spotlight-text">
            <span className="eyebrow" style={{marginBottom:20,display:"block"}}>Next event · {loc.tag}</span>
            <h2 className="display" style={{fontSize:"clamp(36px,5vw,68px)",marginBottom:20}}>{loc.headline}</h2>
          ...
          <Reveal delay={100} className="spotlight-visual">
            <RotatingPhoto imgs={loc.imgs} alt={`${loc.city} venue`} className="spotlight-img" />
            <div className="spotlight-location-badge">
              <div>
                <div className="spotlight-location-city">{loc.city}</div>
                <div className="small" style={{color:"var(--ink-2)"}}>{loc.region}</div>
              </div>
              <div style={{marginLeft:"auto",textAlign:"right"}}>
                <div className="eyebrow">{loc.dateShort}</div>
                <div className="eyebrow">June 2026</div>
              </div>
            </div>
          </Reveal>
        </div>
...
function ModelTeaser() {
  const pillars = SUB.framework.slice(0, 4);
  return (
    <section className="section section-alt" id="model">
      <div className="container">
        <Reveal as="div" className="section-head">
          <span className="eyebrow">The model</span>
          <h2 className="display" style={{fontSize:"clamp(36px,4.5vw,60px)"}}>Not just another conference.</h2>
          <p className="lede">SUB runs on a framework that puts community, practical content and real value first — every time, in every suburb.</p>
        </Reveal>
        ...
        <Reveal><a href="about.html#model" className="btn btn-ghost">See the full model →</a></Reveal>
      </div>
    </section>
  );
}
...
function CommunitySnippet() {
  return (
    <section className="section" id="community">
      <div className="container">
        <div className="community-snippet-grid">
          <Reveal className="community-snippet-text">
            <span className="eyebrow">Community &amp; giving</span>
            <h2 className="display" style={{fontSize:"clamp(36px,4.5vw,60px)",margin:"12px 0 20px"}}>
              40% of every ticket to local charities.
            </h2>
            <p className="lede" style={{marginBottom:28}}>
              Every SUB event is a fundraiser in disguise. We partner with local charities at each location and direct a meaningful share of ticket revenue back into the communities that show up for us.
            </p>
            <a href="community.html" className="btn btn-ghost">Our community mission →</a>
          </Reveal>
          <Reveal delay={100}>
            <div className="eyebrow" style={{marginBottom:16}}>2026 charity partners</div>
            <div className="charity-snippet-pills">
              {SUB.charities.map(c => (
                <span key={c} className="charity-pill">{c}</span>
              ))}
            </div>
          </Reveal>
        </div>
...
window.SubSections = { Hero, About, AboutSnippet, EventSpotlight, ModelTeaser, CommunitySnippet, Features, Locations, Speakers, Schedule, Supporters, Testimonials, Exhibitors, Tickets, Gallery, FAQ, Sponsor, NewsletterFooter, Founders, Framework, Panels, Journey, CharityImpact, SubDifference, AfterParty };
